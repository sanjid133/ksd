...
import (
	...
	demov1 "github.com/sanjid133/ksd/apis/sho/v1"
...
func (c *Operator) demoSyncHandler(key string) error {
	...
	secdb, err := c.secdbLister.Ksds(namespace).Get(name)
	if err != nil {
...
func (c *Operator) deleteSecretToSync(namespace, label string) error {
